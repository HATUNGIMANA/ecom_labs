                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="" class="mt-4" id="login-form">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control animate__animated animate__fadeInUp" id="customer_email" name="customer_email" placeholder="Enter your email address" required>
                            </div>
                            <div class="mb-4">
                                <label for="customer_pass" class="form-label">Password <i class="fa fa-lock"></i></label>
                                <input type="password" class="form-control animate__animated animate__fadeInUp" id="customer_pass" name="customer_pass" placeholder="Enter your password" required>
                            </div>
                            <button type="submit" class="btn btn-custom w-100 animate-pulse-custom" id="login-submit-btn">
